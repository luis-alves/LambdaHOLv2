...
public class A_Lambdas {
    ...
    public void a_predicate1() {
        Predicate<String> pred = word -> word.length() > 4; // TODO
    ...
    public void a_predicate2() {
        Predicate<String> pred = word -> word.isEmpty(); // TODO
    ...
    public void b_function1() {
        Function<String, String> func = word -> new StringJoiner("", "(" + word, ")").toString(); // TODO
    ...
    public void b_function2() {
        Function<String, String> func = word -> word.toUpperCase(); // TODO
    ...
    public void b_function4() {
        ...
        Function<String, Integer> lengthBis = word -> unNullify.andThen(length).apply(word); // TODO
    ...
    public void c_consumer4() {
        ...
        Consumer<List<String>> consumer = list -> c1.andThen(c2).accept(list); // TODO
    ...
    public void e_bifunction2() {
        BiFunction<String, String, Integer> bifunc = (w1, w2) -> w1.indexOf(w2); // TODO
